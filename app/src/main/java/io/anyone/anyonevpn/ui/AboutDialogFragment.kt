...
import io.anyone.anyonevpn.core.DiskUtils
...
class AboutDialogFragment : DialogFragment() {
    ...
    companion object {
        ...
        const val VERSION = "${BuildConfig.VERSION_NAME} (Tor ${AnyoneVpnService.BINARY_ANON_VERSION})"
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return AlertDialog.Builder(context, R.style.AnyoneVpnDialogTheme)
