...
import io.anyone.anyonevpn.utils.AnyoneVpnDatabase

class HostedServicesContentProvider : ContentProvider() {

    private lateinit var mDatabase: AnyoneVpnDatabase

    override fun onCreate(): Boolean {
        mDatabase = AnyoneVpnDatabase(context)
    ...
    override fun query(uri: Uri, projection: Array<String>?, selection: String?,
        ...
        return mDatabase.readableDatabase.query(
            AnyoneVpnDatabase.HOSTED_SERVICES_TABLE_NAME,
