...
public class CustomAnonResourceInstaller {
    ...
    public void installGeoIP() throws IOException {
        ...
        assetToFile(AnyoneVpnConstants.GEOIP_ASSET_KEY, AnyoneVpnConstants.GEOIP_ASSET_KEY, false, false);
        assetToFile(AnyoneVpnConstants.GEOIP6_ASSET_KEY, AnyoneVpnConstants.GEOIP6_ASSET_KEY, false, false);
    }
